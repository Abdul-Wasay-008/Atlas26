            ...
            if (object) {
                ...
                if (isSatellite && !cameraController.snapDisabled) {
                    ...
                    cameraController.startSnap(
                        selectedId as "sun" | "mercury" | "venus" | "earth" | "mars" | "jupiter" | "saturn" | "uranus" | "neptune" | "moon" | "phobos" | "deimos" | "io" | "europa" | "ganymede" | "callisto" | "mimas" | "enceladus" | "tethys" | "dione" | "rhea" | "titan",
                        worldPos
                    );
                }
            } else {
